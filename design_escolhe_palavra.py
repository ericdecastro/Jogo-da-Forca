...
class Ui_EscolhePalavra(object):
    def setupUi(self, EscolhePalavra):
        ...
        EscolhePalavra.resize(463, 173)
        self.centralwidget = QtWidgets.QWidget(EscolhePalavra)
        self.centralwidget.setObjectName("centralwidget")
        self.okButton = QtWidgets.QPushButton(self.centralwidget)
        self.okButton.setGeometry(QtCore.QRect(190, 100, 101, 28))
        self.okButton.setObjectName("okButton")
        self.labelDigitePalavra = QtWidgets.QLabel(self.centralwidget)
        self.labelDigitePalavra.setGeometry(QtCore.QRect(10, 9, 451, 24))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setItalic(True)
        self.labelDigitePalavra.setFont(font)
        self.labelDigitePalavra.setObjectName("labelDigitePalavra")
        self.textDigitePalavra = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.textDigitePalavra.setGeometry(QtCore.QRect(10, 50, 441, 31))
